...
if (isset($_GET['id'])) {
    ...
    // Query untuk mengambil detail siswa berdasarkan NISN
    ...
    echo "<script>alert('NISN tidak valid.'); window.location.href = 'Guru.php';</script>";
    exit;
}
?>
...
<head>
  <meta charset="utf-8" />
  <title>View Data Guru - Management System</title>
...
<nav class="navbar navbar-expand-lg">
  ...
  <!-- Navbar End -->
    ...
    <div class="container">
      ...
      <a href="Guru.php" class="back-button">Kembali</a>
    </div>
